...
export default class EscapeGamesController implements BaseController {
    ...
    public async getEscapeGameByThreaters(params: {threater: string , lang: string }, res: Response): Promise<Response> {

        try {

            const data = await this.scrappingService.escapeGameByTheater();
